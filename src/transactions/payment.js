    ...
    <Fragment>
      ...
      >
        <View style={{ position: "absolute", flex: 1, top: -30, zIndex: 10 }}>
          <Image
            source={{uri:"https://images.unsplash.com/photo-1556157382-97eda2d62296?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"}}
            style={{
              width: 50,
              height: 50,
              borderRadius: 50,
        ...
        <View style={{ position: "absolute", flex: 1, left: -30, zIndex: 10 }}>
          <Image
              source={{uri:"https://images.unsplash.com/photo-1576558656222-ba66febe3dec?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"}}
            style={{
              width: 50,
              height: 50,
              borderRadius: 50,
        ...
        <View style={{ position: "absolute", flex: 1, right: -30, zIndex: 10 }}>
          <Image
              source={{uri:"https://images.unsplash.com/photo-1531750026848-8ada78f641c2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"}}
            style={{
              width: 50,
              height: 50,
              borderRadius: 50,
        ...
        >
          <Image
              source={{uri:"https://images.unsplash.com/photo-1595152452543-e5fc28ebc2b8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=80"}}
            style={{
              width: 50,
              height: 50,
              borderRadius: 50,
        ...
        >
          <Image
              source={{uri:"https://images.unsplash.com/photo-1589729482945-ca6f3a235f7a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"}}
            style={{
              width: 50,
              height: 50,
              borderRadius: 50,
