    ...
    <View style={{ flex: 1, backgroundColor: "#F4F8FD" }}>
      ...
      <View>
        <View style={{ flexDirection: "row", marginTop: 30 }}>
          <View>
            <Image
              source={{uri:"https://images.unsplash.com/photo-1594054771800-7b80ffaf0071?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=988&q=80"}}
              style={{
                height: 300,
                width: 190,
                borderRadius: 10,
